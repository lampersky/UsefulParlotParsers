...
namespace Lampersky.Compilation
{
    ...
    {
        internal static MethodInfo Scanner_ReadSingleQuotedIdentifier = typeof(IdentifiersScannerExtensions).GetMethod(nameof(IdentifiersScannerExtensions.ReadSingleQuotedIdentifier), new Type[1] { typeof(Scanner) });
        internal static MethodInfo Scanner_ReadDoubleQuotedIdentifier = typeof(IdentifiersScannerExtensions).GetMethod(nameof(IdentifiersScannerExtensions.ReadDoubleQuotedIdentifier), new Type[1] { typeof(Scanner) });
        internal static MethodInfo Scanner_ReadSquareBracketsQuotedIdentifier = typeof(IdentifiersScannerExtensions).GetMethod(nameof(IdentifiersScannerExtensions.ReadSquareBracketsQuotedIdentifier), new Type[1] { typeof(Scanner) });
        internal static MethodInfo Scanner_ReadQuotedIdentifierWithPredicate = typeof(IdentifiersScannerExtensions).GetMethod(nameof(IdentifiersScannerExtensions.ReadQuotedIdentifier), new Type[3] { typeof(Scanner), typeof(Func<char, bool>), typeof(Func<char, char>) });
        ...
        internal static MethodInfo Scanner_GetCharFromIndex = typeof(IdentifiersScannerExtensions).GetMethod(nameof(IdentifiersScannerExtensions.GetCharFromIndex), new Type[2] { typeof(Scanner), typeof(int) });
